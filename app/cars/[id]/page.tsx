...
const cars = [
  ...
  {
    id: 5,
    image: "/images/3dimages/front.webp",
    title: "Astrler V300",
    description: "Born on the track, refined for the road. The V300 delivers raw power wrapped in aerodynamic elegance — a machine that responds to every instinct.",
    price: "850$",
    horsepower: "620 HP",
  ...
  {
    id: 6,
    image: "/images/3dimages/purple04.webp",
    title: "Lesiac Z1500",
    description: "Silence is its weapon. The Z1500 fuses cutting-edge electric propulsion with a sculpted body that cuts through air — and expectations.",
    price: "1200$",
    horsepower: "1500 HP",
    Acceleration: "0-100 km/h : 2.7 seconds",
    topSpeed: "350 km/h",
    engineType: "All-Electric Dual Motor",
    transmission: "Single-Speed Automatic",
    fuelConsumption: "18.5 kWh/100 km",
    emissions: "0 g/km",
    doors: "2",
    seats: "2",
    bodyStyle: "Coupe",
