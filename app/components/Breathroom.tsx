...
const Breathroom = ({ title, slogan }: BreathroomProps) => {
    ...
    return (
        <div className="w-full h-[80vh] flex flex-col justify-center items-center bg-[url('/images/car90.jpg')] bg-cover bg-no-repeat bg-center bg-blend-multiply bg-blue-900 overflow-hidden px-4 text-center">
